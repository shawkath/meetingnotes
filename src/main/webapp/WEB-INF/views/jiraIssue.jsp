...
<html>
<head>
    <title>Welcome to Meeting Notes</title>
    <meta charset="utf-8">
...
<div>
      ...
      <!--   <div id="theme-setting">
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="navbar-header">
                ...
                <a id="logo" href="index.html" class="navbar-brand"><span class="fa fa-rocket"></span><span class="logo-text">MeetingNotes</span><span style="display: none" class="logo-text-icon">µ</span></a></div>
            <div class="topbar-main"><a id="menu-toggle" href="#" class="hidden-xs"><i class="fa fa-bars"></i></a>
                ...
                <div class="news-update-box hidden-xs"><span class="text-uppercase mrm pull-left text-white">News:</span>
                    <ul id="news-update" class="ticker list-unstyled">
                        <li>Welcome to Meeting Minutes Application</li>
                        <li>A one stop solution for keeping all your meeting notes in a single place</li>
                    </ul>
                </div>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    </i><span class="menu-title">My Meetings</span></a>
            ...
            <div id="page-wrapper">
                ...
                <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                    ...
                    <ol class="breadcrumb page-breadcrumb pull-right">
                        ...
                        <li class="active">JIRA Details</li>
                    </ol>
                    <div class="clearfix">
                    </div>
                </div>
    ...
    <script src="<%=request.getContextPath()%>/script/charts-highchart-more.js"></script>
     ...
     <script src="<%=request.getContextPath()%>/js/jira.js"></script>
    <!--CORE JAVASCRIPT-->
